...
public class BoardDaoTest {
	...
	public void ghMoreInsertTest() {
		GH_BoardBean b = GH_BoardBean.builder().no(5).party_menu("바베큐").alcohol("쌉가능").party_time("8시")
	...
	public void ghRoomInsertTest() {
		GH_BoardBean b = GH_BoardBean.builder().no(5).room("트윈룸").room_status("1").price(1000000).photo("사진")
				.room_people(2).build();
