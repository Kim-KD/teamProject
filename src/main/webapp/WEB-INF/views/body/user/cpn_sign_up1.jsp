...
$(function(){
	...
	$("#cpn_service_num").focusout(function(){
		$("#service_num_msg").empty();
	});
	$("#cpn_bank").focusout(function(){
		$("#bank_msg").empty();
	});
	$("#cpn_account").focusout(function(){
		$("#account_msg").empty();
	});
});
			...
			<div class="form-group">
				...
				<div class="btn-group" data-toggle="buttons">
					<label class="btn btn-primary">
						<input type="radio" id="user_gender" autocomplete="off" value="m" name="user_gender">남자
					</label>
					<label class="btn btn-danger">
						<input type="radio" id="user_gender" autocomplete="off" value="g" name="user_gender">여자
					</label>
				</div>
			</div>
