...
$(function(){
	...
	$("#update_btn").on("click", function() {
		$.ajax({
			url: "/guehamo/trip_update",
			method: "post",
			data: $("#update_form").serialize(),
			success: function() {
				location.href="/guehamo/trip_read?no="+"${board.no}"
			},error(){
...
<section class="contact-section">
    ...
    <div class="section-title">
        ...
        <form id="update_form" class="contact-form" action="/guehamo/trip_update" method="post" enctype="multipart/form-data">
