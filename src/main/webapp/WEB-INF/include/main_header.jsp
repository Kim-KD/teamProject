			...
			<sec:authorize access="isAuthenticated()">
				<div class="header-right">
					<ul class="main-menu">
						...
						<li><a href="#" id="profile_read" data-toggle="modal">${loginId}님
								환영합니다.</a>
							<ul class="sub-menu">
			...
			<sec:authorize access="isAnonymous()">
				<div class="header-right">
					<div class="user-panel">
						<a href="login" class="login" id="login">로그인</a> <a href="#"
							class="register" id="sign_up" data-toggle="modal">회원가입</a>
					</div>
				</div>
			</sec:authorize>
		</nav>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<div class="container">
							<div class="form-group">
								<div id="select">
									<a href="sign_up"><button class="btn btn-info">일반
											회원</button></a> <a href="cpn_sign_up"><button class="btn btn-success">기업
											회원</button></a>
								</div>
							</div>
						</div>
